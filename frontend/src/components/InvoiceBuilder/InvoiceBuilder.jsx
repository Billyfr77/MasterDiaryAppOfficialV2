      ...
      <div className="max-w-[1800px] mx-auto">
        <div className="flex justify-between items-center mb-10 gap-6">
          ...
          <div className="flex gap-4">
             <button onClick={() => generatePDF('invoice-preview', invoice.invoiceNumber)} className="flex items-center gap-2 px-6 py-3 bg-stone-800 hover:bg-stone-700 text-gray-300 rounded-xl font-bold text-xs uppercase transition-all"><Printer size={16} /> Print / Download</button>
