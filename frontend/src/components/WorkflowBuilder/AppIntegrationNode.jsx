            ...
            >
                <div className="flex items-center gap-3">
                    <div className={`p-2 bg-indigo-500/20 rounded-lg text-indigo-400 ${liteMode ? '' : 'group-hover:scale-110 transition-transform'}`}>
                        <Zap size={16} className={liteMode ? '' : "animate-pulse"} />
                    </div>
                    <div>
    ...
    const handleAction = (e) => {
        ...
        return (
            ...
            >
                 ...
                 <AnimatePresence>
                     {type === 'wormholeNode' && isHovered && data.config?.targetWorkflow && !liteMode && (
                         <motion.div
                    ...
                    <div className="space-y-3 bg-white/5 rounded-xl p-3 border border-white/5 mb-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-1">
                                    <div className={`px-2 py-1.5 rounded bg-emerald-500/10 border border-emerald-500/20 text-[9px] font-black text-emerald-400 uppercase text-center flex items-center justify-center gap-1`}>
                                        <span className={`w-1.5 h-1.5 rounded-full bg-emerald-500 ${liteMode ? '' : 'animate-pulse'}`}></span>
                                        {config.status || 'DRAFT'}
                                    </div>
                                    <button 
                        ...
                        {type === 'forensicNode' && (
                            <div className="flex flex-col gap-3">
                                ...
                                <div className={`px-2 py-1 rounded bg-violet-500/10 border border-violet-500/20 text-[8px] font-black text-violet-400 uppercase text-center ${liteMode ? '' : 'animate-pulse'}`}>
                        ...
                        {type === 'delayNode' && (
                            <>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <Clock size={12} className={`text-orange-400 ${liteMode ? '' : 'animate-spin-slow'}`} />
                        ...
                        {type === 'wormholeNode' && (
                            <div className="flex flex-col gap-3 relative overflow-hidden p-1">
                                ...
                                <div className={`absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none ${liteMode ? 'hidden' : ''}`}>
                                ...
                                <div className={`px-2 py-1 rounded bg-fuchsia-500/10 border border-fuchsia-500/20 text-[8px] font-black text-fuchsia-300 uppercase text-center ${liteMode ? '' : 'animate-pulse'}`}>
                        ...
                        {type === 'mapNode' && (
                            <div className="flex flex-col gap-3 relative">
                                {/* Radar Scan Effect */}
                                <div className={`absolute top-0 right-0 w-16 h-16 opacity-20 pointer-events-none overflow-hidden rounded-full border border-blue-400/30 bg-blue-900/20 ${liteMode ? 'hidden' : ''}`}>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-white/5">
                        <div className="flex items-center gap-2">
                            <div className={`w-2 h-2 rounded-full ${
                                ...
                                status === 'in-progress' ? `bg-amber-500 ${liteMode ? '' : 'animate-pulse'}` : 'bg-slate-600'
                            }`} />
