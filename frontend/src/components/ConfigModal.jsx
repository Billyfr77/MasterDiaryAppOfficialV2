...
const ConfigModal = ({ isOpen, item, suggestedQuantity, onClose, onConfirm }) => {
  ...
  const handleConfirm = () => {
    onConfirm(Number(quantity), 0, Number(customCharge), name);
  };
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white text-lg font-bold focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
            />
          </div>
