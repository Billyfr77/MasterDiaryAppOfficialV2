...
const TabContent = ({ activeTab, aiAnalysis, healthStatus, filteredData, metrics }) => {
  if (activeTab === 'gemini') {
    return (
  ...
  if (activeTab === 'overview') {
    return (
      <React.Fragment>
        ...
        <div className="mt-6 bg-stone-900/40 rounded-3xl p-6 border border-white/10 backdrop-blur-md shadow-xl">
